...
Content.format =  function(obj) {
    let html = template;
    html = html.replace('{{home}}', obj.title);
...
/*  Hero.render
    ...
    un sel objet de données Hero dedans. C'est plus flexible ainsi.
*/
...
console.log(data)
    ...
    let html = '';
    for(let obj of data){
        html += Content.format(obj); // on concatène les HTML des composants formatés  
    }
