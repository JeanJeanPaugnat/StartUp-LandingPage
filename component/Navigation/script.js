...
let template__card = await loadTemplate('./component/Navigation/template__card.html');
...
Navigation.render = async function(selector, jsonFilename){
    ...
    let html = '';
    for(let obj of data){
        html += Navigation.format(obj); // on concatène les HTML des composants formatés  
    }
