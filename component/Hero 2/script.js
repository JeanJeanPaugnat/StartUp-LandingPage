...
let template = await loadTemplate('./component/Hero 2/template.html');
...
*/
Hero2.render = async function(selector, jsonFilename){
    ...
    let html = '';
    for(let obj of data){
        html += Hero2.format(obj); // on concatène les HTML des composants formatés  
    }
